                ...
                <div class="position-sticky">
                    <div id="mySidebar" class="sidebar">
                        <div class="list-group list-group-flush mx-3 mt-4">
                            ...
                            <a href="{{ url('/staff') }}" class="list-group-item list-group-item-action py-2 ripple"
                                aria-current="true">
                            ...
                            <li class="nav-item dropdown list-group-item-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-end " aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/staff/seat/ms_view"><i
                                            class="fa-solid fa-route me-3"></i>ဘူးသီးတောင်-စစ်တွေ(မနက်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/seat/ms2_view"><i
                                            class="fa-solid fa-route me-3"></i>ဘူးသီးတောင်-စစ်တွေ(နေ့လည်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/seat/sm_view"> <i
                                            class="fa-solid fa-route me-3"></i> စစ်တွေ-ဘူးသီးတောင်(မနက်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/seat/sm2_view"> <i
                            ...
                            <li class="nav-item dropdown list-group-item-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-end " aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/staff/customer/view/ms"><i
                                            class="fa-solid fa-arrow-right-long me-3"></i>ဘူးသီးတောင်-စစ်တွေ(မနက်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/customer/view/ms2"><i
                                            class="fa-solid fa-arrow-right-long me-3"></i>ဘူးသီးတောင်-စစ်တွေ(နေ့လည်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/customer/view/sm"><i
                                            class="fa-solid fa-arrow-left-long me-3"></i>စစ်တွေ-ဘူးသီးတောင်(မနက်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/customer/view/sm2"><i
                                            class="fa-solid fa-arrow-left-long me-3"></i>
                                        စစ်တွေ-ဘူးသီးတောင်(နေ့လည်ပိုင်း)</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown list-group-item-action">
                                <a href="#"
                                ...
                                <div class="dropdown-menu dropdown-menu-end " aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/staff/print/view/ms"><i
                                            class="fa-solid fa-arrow-right-long me-3"></i>ဘူးသီးတောင်-စစ်တွေ(မနက်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/print/view/ms2"><i
                                            class="fa-solid fa-arrow-right-long me-3"></i>ဘူးသီးတောင်-စစ်တွေ(နေ့လည်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/print/view/sm"><i
                                            class="fa-solid fa-arrow-left-long me-3"></i>
                                        စစ်တွေ-ဘူးသီးတောင်(မနက်ပိုင်း)</a>
                                    <a class="dropdown-item" href="/staff/print/view/sm2"><i
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <form id="logout-form" action="{{ route('staff.logout') }}" method="GET"
                                        class="d-none">
                                        @csrf
                                    </form>
                                </div>
