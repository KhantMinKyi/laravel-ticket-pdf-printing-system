...
<style>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <table class="table">
                <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('staff/seat/ms2_view')}}">
       @csrf
  ...
  <tr>
      ...
      @if($key%4== 0)
        ...
        @else <th scope="row" style="background-color:white;"><a href="{{  route('staff.seat.detail',[$seat['id'],$date,'ms2'])}}">
        @endif
