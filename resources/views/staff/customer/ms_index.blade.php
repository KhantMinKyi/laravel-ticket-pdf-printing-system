...
<div class="card">
                ...
                <div class="card-body">
                <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('staff/customer/view/ms')}}">
       @csrf
 ...
 ({{$customers->count()}})</h3>
    ...
    <tbody>
      ...
      <td><a class="name" href="{{  route('staff.customer.detail',[$customer['seat_id'],$customer['id'],$date,'ms'])}}">{{$customer->name}}</a></td>
