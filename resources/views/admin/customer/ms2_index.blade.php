...
<div class="card">
                ...
                <div class="card-body">
                <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('admin/customer/view/ms2')}}">
       @csrf
 ...
 ({{$customers->count()}})</h3>
    ...
    <tbody>
      ...
      <td><a class="name" href="{{  route('admin.customer.detail',[$customer['seat_id'],$customer['id'],$date,'ms2'])}}">{{$customer->name}}</a></td>
