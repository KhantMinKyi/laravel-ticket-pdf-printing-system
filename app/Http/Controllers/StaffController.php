...
class StaffController extends Controller
{
    ...
    public function ms_viewdailyseat(Request $request){
        ...
        return view('staff.seat.ms_index',[
            'seats'=>$seats,
            'date'=>$date
        ]);
    ...
    public function ms2_viewdailyseat(Request $request){
        ...
        $seats=Seat::Orderby('id')->paginate(50);
        return view('staff.seat.ms2_index',[
            'seats'=>$seats,
            'date'=>$date
        ]);
    ...
    public function sm_viewdailyseat(Request $request){
        ...
        $seats=Seat::Orderby('id')->paginate(50);
        return view('staff.seat.sm_index',[
            'seats'=>$seats,
            'date'=>$date
        ]);
    ...
    public function sm2_viewdailyseat(Request $request){
        ...
        $seats=Seat::Orderby('id')->paginate(50);
        return view('staff.seat.sm2_index',[
            'seats'=>$seats,
            'date'=>$date
        ]);
    ...
    public function seatadd(Request $request)
    {
        ...
        for ($count = 0; $count < count($seat_no) ; $count++){
           ...
           if($request->type ==="ms"){
               ...
               elseif ($seat->ms_date7==null) {$seat->ms_date7=$request->date;}
                else return redirect('staff/seat/ms_view')->with('status', 'Cannot Add Data Range Over 7 Days');
                $seat->update();
                $user = new Customer;
                ...
                else return redirect('staff/seat/sm_view')->with('status', 'Cannot Add Data Range Over 7 Days');
                $seat->update();
                $user = new Customer;
                $user->seat_id =$seat_no_decode;
                $user->name = $request->name;
        ...
        if($request->type ==="ms"){
        return redirect('staff/seat/ms_view')->with('status', 'Add User Form Data Has Been inserted');
        }
        else if($request->type ==="sm"){
            return redirect('staff/seat/sm_view')->with('status', 'Add User Form Data Has Been inserted');
        }
        else if($request->type ==="ms2"){
            return redirect('staff/seat/ms2_view')->with('status', 'Add User Form Data Has Been inserted');
        }
        else if($request->type ==="sm2"){
            return redirect('staff/seat/sm2_view')->with('status', 'Add User Form Data Has Been inserted');
        }
        ...
        public function viewdailymscustomer(Request $request){
            ...
            return view('staff.customer.ms_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        ...
        public function viewdailyms2customer(Request $request){
            ...
            return view('staff.customer.ms2_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        ...
        public function viewdailysmcustomer(Request $request){
            ...
            return view('staff.customer.sm_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        ...
        public function viewdailysm2customer(Request $request){
            ...
            return view('staff.customer.sm2_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        ...
        public function customerdetail($seat_id,$id,$date,$type){
            ...
            return view('staff.customer.detail',[
                'customer'=>$customer,
                'date'=>$date,
                'type'=>$type,
            ]);
        ...
        public function customerdelete(Request $request){
            ...
            if ($request->type == 'ms') {
                ...
                $customer->delete();
                $seat->update();
                return redirect('staff/seat/ms_view')->with('status', 'Cancle Booking Done');
            }
            elseif($request->type == 'sm') {
                ...
                $customer->delete();
                $seat->update();
                return redirect('staff/seat/sm_view')->with('status', 'Cancle Booking Done');
                ...
                $customer->delete();
                $seat->update();
                return redirect('staff/seat/ms2_view')->with('status', 'Cancle Booking Done');
            }
            elseif($request->type == 'sm2') {
                ...
                $customer->delete();
                $seat->update();
                return redirect('staff/seat/sm2_view')->with('status', 'Cancle Booking Done');
            }
        ...
        public function viewdailymsview(Request $request)
        {
            ...
            return view('staff.print.ms_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        }
        ...
        public function viewdailyms2view(Request $request)
        {
            ...
            return view('staff.print.ms2_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        }
        ...
        public function viewdailysmview(Request $request)
        {
            ...
            return view('staff.print.sm_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        }
        ...
        public function viewdailysm2view(Request $request)
        {
            ...
            return view('staff.print.sm2_index',[
                'customers'=>$customers,
                'date'=>$date
            ]);
        }
        ...
        public function viewdailymsprint(Request $request)
        {
            ...
            $document->WriteHTML(view('staff.print.detail',[
                'customers'=>$customers,
                'type'=>$type,
                'date'=>$date,
            ]));
